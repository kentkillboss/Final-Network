...
export default function PictureGrid(props) {
                ...
                if (index !== 0) {
                  if (isAVideo(image)) {
                    return (
                      <Grid item md={12} lg={12} xl={12} xs={12} sm={12}>
                        <Grid container direction="row" justify="center">
                          <video width="100%" height="auto" style={{ maxHeight: 205 }} src={image} controls />
                        </Grid>
                      </Grid>
                    );
                  } else {
  ...
  return (
    <div style={{ width: props.width, maxWidth: props.maxWidth, filter: theme ? 'invert(1)' : 'invert(0)' }}>
      ...
      {showImage && (
        ...
        >
          <Grid container direction="row" justify="center">
            <img style={{ maxWidth: '100%' }} src={showImage} alt=""></img>
          </Grid>
        </Dialog>
      )}
    </div>
